      ...
      <main>
        <Presentation>
          <div className="content">
            <h1 className="slogan">
              Com a <span>PIZY</span>, tudo fica muito mais <span>easy</span>.
            </h1>
          ...
          <MembersSection>
            <div className="wrapper">
              <div className="container">
                <div className="title">
                  <span>Estão conosco</span>
                  <p>
                    Conheça um pouco das pessoas que embarcaram nesta jornada da
                    PIZY para um mercado júnior mais destacado.
                  </p>
                </div>
                ...
                <div className="about-user">
                  <div className="user-name">
                    ...
                    <p>Marcelo Augusto Domingos</p>
                  </div>

                  <p className="user-bio">
                    Front-End Developer • Motion & Graphic Designer
                  </p>

                  {/* <a href="/user/gelzinn">Visitar Perfil</a> */}
                </div>

                <div className="obs">
                  A partir do momento em que você se cadastra em nossa
                  plataforma e passa a utilizar de nossa comunidade, você pode
                  aparecer por aqui. Será bom te vê-lo!
                </div>
              </div>

              <MembersCircle>
                <img src="../assets/member-circle.png" />
                <img id="mobile" src="../assets/member-circle-mobile.png" />
              </MembersCircle>
            </div>
          </MembersSection>
        </PurposeAndMembersCircle>
        ...
        <OurCommunity>
          <div className="container">
            <div className="content">
              ...
              <div>
                <p>
                  Caso queira colaborar conosco e com nosso projeto para
                  crescimento do mercado de trabalho júnior, você pode se juntar
                  ao nosso servidor do Discord.
                </p>
            ...
            <img
              src="../../assets/discord-print.png"
              alt="PIZY Discord Server"
              id="PIZYDiscordServer"
            />
          </div>
        </OurCommunity>
      </main>
